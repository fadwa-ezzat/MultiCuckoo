...
/*  37 */   int steps = 0;
/*     */ 
/* 126 */   protected Color goodColor = new Color(0, 0, 0);
/* 127 */   protected Color goodMarkColor = new Color(255, 0, 0);
/*     */ 
...
/*     */ 
/*  46 */     Bag mysteriousObjects = hb.environment.getNeighborsWithinDistance(this.agentLocation, 1000.0D);
...
/*  59 */             if (ta.isInfected())
/*     */             {
/*  61 */               if (hb.withinHealingDistance(this, this.agentLocation, ta, ta.agentLocation)) {
/*  62 */                 ta.setInfected(false);
/*     */               }
...
/*     */   {
/* 130 */     double diamx = info.draw.width * 8.0D;
/* 131 */     double diamy = info.draw.height * 8.0D;
/*     */ 
/* 133 */     graphics.setColor(this.goodColor);
/* 134 */     graphics.fillOval((int)(info.draw.x - diamx / 2.0D), (int)(info.draw.y - diamy / 2.0D), (int)diamx, (int)diamy);
/* 135 */     graphics.setColor(this.goodMarkColor);
/* 136 */     graphics.fillRect((int)(info.draw.x - diamx / 3.0D), (int)(info.draw.y - diamy / 16.0D), (int)(diamx / 1.5D), (int)(diamy / 8.0D));
/* 137 */     graphics.fillRect((int)(info.draw.x - diamx / 16.0D), (int)(info.draw.y - diamy / 3.0D), (int)(diamx / 8.0D), (int)(diamy / 1.5D));
/*     */   }
 ...
 * Qualified Name:     sim.app.virus.Good
