...
/*    */     }
/*    */ 
/* 61 */     sumForces.addIn(new Double2D((yard.width * 0.5D - me.x) * students.forceToSchoolMultiplier, (yard.height * 0.5D - me.y) * students.forceToSchoolMultiplier));
/*    */ 
/* 65 */     sumForces.addIn(new Double2D(students.randomMultiplier * (students.random.nextDouble() * 1.0D - 0.5D), students.randomMultiplier * (students.random.nextDouble() * 1.0D - 0.5D)));
/*    */ 
/* 68 */     sumForces.addIn(me);
/*    */ 
/* 70 */     students.yard.setObjectLocation(this, new Double2D(sumForces));
/*    */   }
/*    */ }

/* Location:           D:\To Dr-Leena\To Dr-Leena\MultiCuckoo.jar
 * Qualified Name:     sim.app.wcss.tutorial07.Student
